...
import { usernameEmailSettingsSchema , type UsernameEmailSettingsSchema } from "@instamint/shared-types"
...
export const ChangeSettingsForm = (props: ChangeSettingsFormProps) => {
    ...
    if (settingsRequired === "username") {
        return (
            <div>
                <p className="p-4">{translation("settings:label-set-username-email")}</p>
                <Form {...form}>
                    <form
